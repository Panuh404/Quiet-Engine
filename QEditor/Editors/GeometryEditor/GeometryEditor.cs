...
{
    // This is to view 3D geometry in WPF without graphics renderer.
    // We will replace this in the future
    ...
    class MeshRenderer : ViewModelBase
    {
        ...
        public MeshRenderer(MeshLOD lod, MeshRenderer old)
        {
            ...
            // In order to set up camera position and target properly, we need to figure out how big this object is that we're rendering (bounding box).
